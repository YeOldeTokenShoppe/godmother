...
var getIsLowEndDevice = function () {
    // If number of logical processors available to run threads <= 4
    if ((0, constants_1.getHC)() && (0, constants_1.getHC)() <= 4) {
        return true;
    }
    // If the approximate amount of RAM client device has <= 4
    if ((0, constants_1.getDM)() && (0, constants_1.getDM)() <= 4) {
        return true;
    }
    return false;
};
exports.getIsLowEndDevice = getIsLowEndDevice;
var getIsLowEndExperience = function (et, sd) {
    ...
    switch (et) {
        ...
        default:
            ...
            return (0, exports.getIsLowEndDevice)() || sd;
    }
};
