...
export function OnRampTxDetailsTable(props) {
    ...
    return (_jsxs("div", { children: [_jsxs(Container, { flex: "row", style: {
                    justifyContent: "space-between",
                            ...
                            justifyContent: "space-between",
                        }, children: [_jsx(Text, { children: "Status" }), _jsx(Container, { flex: "row", gap: "xs", center: "y", children: _jsx(Text, { color: props.statusMeta.color, children: props.statusMeta.text }) })] })] })), props.fromAddress &&
                props.toAddress &&
                props.fromAddress !== props.toAddress && (_jsxs(_Fragment, { children: [lineSpacer, _jsxs(Container, { flex: "row", center: "y", style: {
                            justifyContent: "space-between",
                        }, children: [_jsx(Text, { children: "Send to" }), _jsx(Container, { flex: "row", gap: "xs", center: "y", children: _jsx(Text, { children: shortenAddress(props.toAddress) }) })] })] })), lineSpacer, onrampTxHash && onRampExplorers.explorers?.[0]?.url && (_jsxs(_Fragment, { children: [_jsx(Spacer, { y: "md" }), _jsxs(ButtonLink, { fullWidth: true, variant: "outline", href: `${onRampExplorers.explorers[0].url || ""}/tx/${onrampTxHash}`, target: "_blank", gap: "xs", style: {
